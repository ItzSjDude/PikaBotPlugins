...
@Infinix(outgoing=True, pattern=r"(\w+)say (.*)")
...
@Infinix(pattern="slap(?: |$)(.*)", outgoing=True)
async def who(event):
...
@Infinix(outgoing=True, pattern="cry$")
async def cry(e):
...
@Infinix(outgoing=True, pattern="insult$")
async def insult(e):
    """ I make you cry !! """
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
...
@Infinix(outgoing=True, pattern="cp(?: |$)(.*)")
...
@Infinix(outgoing=True, pattern="vapor(?: |$)(.*)")
async def vapor(vpr):
    """ Vaporize everything! """
...
@Infinix(outgoing=True, pattern="repo$")
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "Click [Here](https://github.com/ItzSjDude/InfxchuUserbot) to open this mdafuk'in cool userbot repo ."
        )


@Infinix(outgoing=True, pattern="str(?: |$)(.*)")
...
@Infinix(outgoing=True, pattern="zal(?: |$)(.*)")
async def zal(zgfy):
...
@Infinix(outgoing=True, pattern="pkill$")
...
@Infinix(outgoing=True, pattern="bt$")
...
@Infinix(outgoing=True, pattern="rape$")
...
@Infinix(outgoing=True, pattern="pro$")
async def proo(pros):
...
@Infinix(outgoing=True, pattern="fuk$")
...
@Infinix(outgoing=True, pattern="chu$")
...
@Infinix(outgoing=True, pattern="thanos$")
...
@Infinix(outgoing=True, pattern="hardabuse$")
...
@Infinix(outgoing=True, pattern="gey$")
...
@Infinix(outgoing=True, pattern="abuse$")
...
@Infinix(outgoing=True, pattern="owo(?: |$)(.*)")
async def faces(owo):
    """ UwU """
...
@Infinix(outgoing=True, pattern="react$")
...
@Infinix(outgoing=True, pattern="shg$")
...
@Infinix(outgoing=True, pattern="noob$")
...
@Infinix(outgoing=True, pattern="rendi$")
async def metoo(hahayes):
    """ Haha yes """
    if not hahayes.text[0].isalpha() and hahayes.text[0] not in ("/", "#", "@", "!"):
...
@Infinix(outgoing=True, pattern="10iq$")
async def iqless(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("♿")


@Infinix(outgoing=True, pattern="mock(?: |$)(.*)")
...
@Infinix(outgoing=True, pattern="clap(?: |$)(.*)")
...
@Infinix(outgoing=True, pattern="smk (.*)")
async def smrk(smk):
